...
<div id="nav"
    class="font-dm-sans text-body-2 text-text-color-01 flex  w-full px-4 md:px-10 py-4 md:py-10 mx-auto justify-between items-center">
    ...
    <div class="w-1/2 text-lg md:text-md text-center md:text-left mt-4 md:mt-0 hidden md:block">
        <ul class="flex justify-evenly gap-6 md:gap-0">
            <a href="/"
                class=" hover:border rounded-full active:text-[#FB56C2] active:font-bold px-4 py-2">Home</a>
            <a href="#courses"
                class=" hover:border rounded-full active:text-[#FB56C2] active:font-bold px-4 py-2">Courses</a>
            <a href="#blogs"
                class=" hover:border rounded-full active:text-[#FB56C2] active:font-bold px-4 py-2">Blogs</a>
            <a href="#about" class=" hover:border rounded-full active:text-[#FB56C2] active:font-bold px-4 py-2">About
                Us</a>
            <a href="#contact_us"
