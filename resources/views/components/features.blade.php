<div id="courses" class="container mx-auto pt-[40px] h-auto px-4">
    <div class=" flex justify-between items-center mb-[20px]">
        ...
        <a href="/all-courses" class=" text-lg text-[#808081] flex items-center hover:text-[#FB56C2]">See more <span><svg
        ...
        @foreach ($courses as $course)
            <a href="{{ route('course.show', ['id' => $course->id, 'videoId' => 1]) }}" class="border p-[16px] rounded-xl cursor-pointer">
                ...
                <div class=" w-full">
                    ...
                    <div class="pt-4 flex justify-start gap-2 flex-wrap">
                        <div class=" flex items-center gap-3">
                            ...
                            <span class='text-[#808081] text-sm'>Course Duration</span>
                        </div>
                        ...
                        <div class=" flex items-center">
                            ...
                            <span class=" text-[#808081]">{{ $course->duration }} months</span>
                        </div>
